...
phrase_model = pickle.load(open('/Models/phrasemodel.sav','rb'))
...
f = open('/Data/thesaurus_lem.json','rb')
...
tweet = {'body':"covid", "filter_words":[]}
tweet = preprocessing(phrase_model,tweet,FULL_STOP)

model = pickle.load(open('\Models\LinearSVCModel.sav','rb'))
